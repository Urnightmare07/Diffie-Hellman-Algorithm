...
class DiffieHellman:
    ...
    def __calculate_local_number(self):
        # Returns the random chosen exponent and the public number to send to the other peer.
    ...
    def calculate_shared_secret(self, received_number):
        # Calculates the shared secret having the received number and the exponent used for its own operation
